    ...
    <div className="min-h-screen space-y-7 bg-[#F8FAFC] pb-12 font-sans text-[#111827] antialiased">
      ...
      <section className="flex flex-col justify-between gap-4 border-b border-slate-200 pb-5 sm:flex-row sm:items-center">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          >
            <Calendar size={14} className="text-[#174A7C]" />
            Schedule Reports
          </button>
          <button
      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-[#174A7C]/40 hover:shadow-md">
            <div className="flex items-center justify-between">
              <div className="grid size-9 place-items-center rounded-lg bg-[#174A7C]/10 text-[#174A7C]">
                <FileText size={18} />
              </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-[#174A7C]/40 hover:shadow-md">
            <div className="flex items-center justify-between">
              <div className="grid size-9 place-items-center rounded-lg bg-[#2563A8]/10 text-[#174A7C]">
                <History size={18} />
              </div>
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            {(['PDF', 'Excel', 'CSV'] as const).map((fmt) => (
              <button
                ...
                className={`rounded px-2 py-1 font-semibold transition ${
                  selectedFormat === fmt
                    ? 'bg-white text-[#174A7C] shadow-xs'
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-[#F8FAFC] p-5 transition hover:-translate-y-0.5 hover:border-[#174A7C] hover:bg-white hover:shadow-md">
            <div>
            ...
            <div className="mt-5 border-t border-slate-200/60 pt-4">
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-[#174A7C] px-4 py-2.5 text-xs font-bold text-white shadow-sm transition hover:bg-[#123A61] disabled:opacity-50"
              >
          ...
          <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-[#F8FAFC] p-5 transition hover:-translate-y-0.5 hover:border-[#174A7C] hover:bg-white hover:shadow-md">
            <div>
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className="grid size-11 place-items-center rounded-xl bg-[#174A7C]/10 text-[#174A7C]">
                    <History size={22} />
                  </div>
                  <div>
                    <span className="font-mono text-[10px] font-bold uppercase tracking-wider text-[#174A7C]">
                      Auditability & Trail
                    </span>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <section className="flex flex-col justify-between rounded-xl border border-slate-200 bg-white p-6 shadow-sm lg:col-span-7">
          <div>
            ...
            <div className="mt-5 grid grid-cols-1 gap-3.5 sm:grid-cols-2">
              ...
              <div className="rounded-xl border border-slate-200 bg-[#F8FAFC] p-4 transition hover:bg-white hover:border-[#16A34A]/40">
                ...
                <div className="mt-2 font-mono text-[10px] text-[#174A7C]">
          ...
          <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-3 text-[11px] text-[#64748B]">
            ...
            <Link href="/audit-logs/verify" className="font-bold text-[#174A7C] hover:underline">
            ...
            <div className="mt-4 space-y-2.5">
              ...
              <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-[#F8FAFC] p-3 transition hover:bg-white">
                ...
                <button
                  ...
                  className="rounded-lg bg-white border border-slate-200 px-3 py-1.5 text-xs font-bold text-[#174A7C] shadow-xs hover:bg-slate-50 transition"
                >
                  Export PDF
                </button>
              </div>
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="mb-5 flex flex-col justify-between gap-2 sm:flex-row sm:items-center">
          ...
          <div className="flex items-center gap-2 font-mono text-[10px] text-[#64748B]">
            <span className="flex items-center gap-1"><span className="size-2 rounded-full bg-[#174A7C]" /> Audit</span>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          ...
          <div className="rounded-xl border border-slate-200 bg-[#F8FAFC] p-5 lg:col-span-6">
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-xs font-bold text-[#174A7C]">+42% Growth</span>
            </div>
              ...
              {MONTHLY_VOLUME.map((item) => {
                ...
                return (
                  <div key={item.month} className="group relative flex-1 flex flex-col items-center">
                    ...
                    {/* Bar segments */}
                    <div
                      className="w-full rounded-t-md bg-gradient-to-t from-[#174A7C] to-[#2563A8] transition-all duration-500 group-hover:brightness-110"
          ...
          <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-[#F8FAFC] p-5 lg:col-span-6">
              ...
              <div className="mt-5 space-y-4">
                ...
                <div>
                  <div className="mb-1 flex items-center justify-between text-xs">
                    ...
                    <span className="font-mono font-bold text-[#174A7C]">99.8%</span>
                  </div>
                  <div className="h-2 w-full overflow-hidden rounded-full bg-slate-200">
                    <div className="h-full rounded-full bg-[#174A7C]" style={{ width: '99.8%' }} />
                  </div>
                </div>
                ...
                <div>
                  <div className="mb-1 flex items-center justify-between text-xs">
                    ...
                    <span className="font-mono font-bold text-[#2563A8]">97.5%</span>
                  </div>
                  <div className="h-2 w-full overflow-hidden rounded-full bg-slate-200">
                    <div className="h-full rounded-full bg-[#2563A8]" style={{ width: '97.5%' }} />
                  </div>
                </div>
            ...
            <div className="mt-5 border-t border-slate-200 pt-3 flex items-center justify-between text-[11px] text-[#64748B]">
              ...
              <button onClick={() => handleAction("Telemetry Logs", "Exporting complete analytical dataset...")} className="font-bold text-[#174A7C] hover:underline">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <div className="relative">
              ...
              <input
                ...
                className="h-8.5 rounded-lg border border-slate-200 bg-[#F8FAFC] pl-8.5 pr-3 text-xs text-[#111827] placeholder:text-[#64748B] outline-none focus:border-[#174A7C] focus:bg-white w-56"
              />
            </div>
            ...
            <tbody className="divide-y divide-slate-100 text-xs">
              {filteredReports.map((rpt) => (
                <tr key={rpt.id} className="transition hover:bg-slate-50/80">
                  {/* Report ID */}
                  <td className="px-4 py-3 font-mono font-bold text-[#174A7C]">
                    {rpt.id}
                  </td>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2.5">
                      <div className={`grid size-7 place-items-center rounded-md ${
                        ...
                        rpt.type === 'Audit' ? 'bg-[#174A7C]/10 text-[#174A7C]' :
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="flex items-center justify-end gap-1.5">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-2.5 py-1 text-[11px] font-bold text-[#111827] shadow-xs hover:bg-[#174A7C] hover:text-white hover:border-[#174A7C] transition"
                      >
                        <Download size={13} />
                        Download {rpt.format}
                      </button>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
          ...
          {/* Total Documents */}
          <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-[#174A7C]/40 hover:shadow-md">
            <div className="flex items-center justify-between">
              <div className="grid size-8 place-items-center rounded-lg bg-[#174A7C]/10 text-[#174A7C]">
                <FileText size={16} />
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-xl border border-slate-200 bg-white p-6 shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                <Calendar size={18} className="text-[#174A7C]" />
                ...
                <div className="mt-2 space-y-2">
                  {['Integrity Verification Report', 'Audit Trail Export', 'Security Activity Brief', 'Case Investigation Dossier'].map((item) => (
                    <label key={item} className="flex items-center gap-2 text-xs text-[#111827]">
                      <input type="checkbox" defaultChecked className="rounded text-[#174A7C]" />
                      <span>{item}</span>
                    </label>
                  ))}
                </div>
      ...
      {modalType === 'email' && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-xl border border-slate-200 bg-white p-6 shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                <Send size={18} className="text-[#174A7C]" />

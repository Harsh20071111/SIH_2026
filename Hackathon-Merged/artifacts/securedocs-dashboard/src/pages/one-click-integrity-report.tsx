  ...
  return (
    <div className="min-h-screen space-y-7 bg-[#F8FAFC] pb-14 font-sans text-[#111827] antialiased print:bg-white print:p-0">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 pb-3 print:hidden">
        <Link
          href="/reports"
          className="inline-flex items-center gap-1.5 text-xs font-bold text-[#174A7C] hover:text-[#123A61]"
        >
      ...
      <section className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <div className="flex flex-wrap items-center gap-2.5 print:hidden">
          ...
          >
            <RefreshCw size={14} className={isGenerating ? "animate-spin text-[#174A7C]" : "text-[#174A7C]"} />
      ...
      <section className="rounded-2xl border-2 border-slate-300 bg-white p-6 sm:p-8 shadow-md relative overflow-hidden print:border-black print:shadow-none">
        ...
        <div className="border-b-2 border-[#111827] pb-5 text-center">
          <div className="mx-auto flex size-12 items-center justify-center rounded-xl bg-[#0B1220] text-white shadow-sm">
            <ShieldCheck size={28} className="text-[#2563A8]" />
          </div>
          <div className="mt-2 font-mono text-[10px] font-bold tracking-[0.25em] text-[#174A7C] uppercase">
          ...
          <div className="space-y-3 rounded-xl border border-slate-200 bg-[#F8FAFC] p-4">
            ...
            <div>
              ...
              <span className="text-sm font-bold text-[#111827] flex items-center gap-1.5">
                <FileText size={15} className="text-[#174A7C]" />
                Evidence.pdf
              </span>
            </div>
            <div>
              <span className="block font-mono text-[10px] text-[#64748B] uppercase">Document Version:</span>
              <span className="inline-flex rounded bg-[#174A7C]/10 px-2 py-0.5 font-mono text-xs font-bold text-[#174A7C]">
                v3
              </span>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="mt-1 flex items-center justify-between rounded bg-white p-2 border border-slate-200">
                ...
                <button
                  ...
                  className="text-[#174A7C] hover:text-[#123A61] text-[10px] font-bold flex items-center gap-1 shrink-0 ml-2"
                >
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm lg:col-span-6">
          ...
          <div className="relative mt-5 space-y-4 pl-6 before:absolute before:left-2 before:top-2 before:h-[80%] before:w-0.5 before:bg-slate-200">
            ...
            <div className="relative">
              <div className="absolute -left-6 top-1 size-2.5 rounded-full bg-[#174A7C] ring-4 ring-white" />
            ...
            <div className="relative">
              <div className="absolute -left-6 top-1 size-2.5 rounded-full bg-[#2563A8] ring-4 ring-white" />
              <div className="flex items-center justify-between text-xs">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-[#174A7C]/40 hover:shadow-md">
            ...
            <div className="mt-2 font-mono text-2xl font-black text-[#174A7C]">Verified · A+</div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-[#174A7C]/40 hover:shadow-md">
            ...
            <div className="mt-2 font-mono text-3xl font-black text-[#174A7C]">99.9%</div>
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm print:hidden">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
          ...
          <button
            ...
            className="group flex flex-col items-center justify-center rounded-xl border border-slate-200 bg-[#F8FAFC] p-4 text-center transition hover:-translate-y-0.5 hover:border-[#174A7C] hover:bg-white hover:shadow-sm"
          >
            <div className="grid size-11 place-items-center rounded-xl bg-[#174A7C]/10 text-[#174A7C] group-hover:bg-[#174A7C] group-hover:text-white transition">
              <Download size={20} />
            </div>
          ...
          <button
            ...
            className="group flex flex-col items-center justify-center rounded-xl border border-slate-200 bg-[#F8FAFC] p-4 text-center transition hover:-translate-y-0.5 hover:border-[#174A7C] hover:bg-white hover:shadow-sm"
          >
            <div className="grid size-11 place-items-center rounded-xl bg-[#2563A8]/10 text-[#174A7C] group-hover:bg-[#174A7C] group-hover:text-white transition">
              <FileCheck size={20} />
            </div>
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-12 items-center">
          ...
          <div className="md:col-span-4 flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-[#174A7C]/40 bg-[#174A7C]/5 p-6 text-center">
            <div className="grid size-16 place-items-center rounded-full bg-[#174A7C] text-white shadow-md">
              <Award size={36} />
            </div>
            <div className="mt-3 font-mono text-xs font-black uppercase text-[#174A7C] tracking-wider">
              DIGITAL VERIFICATION SEAL
            </div>
          ...
          <div className="md:col-span-8 space-y-3 text-xs">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="rounded-lg bg-[#F8FAFC] p-3 border border-slate-200">
                ...
                <span className="font-mono font-bold text-[#174A7C]">{verificationId}</span>
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4 backdrop-blur-sm print:hidden">
          <div className="w-full max-w-md rounded-xl border border-slate-200 bg-white p-6 shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                <Share2 size={18} className="text-[#174A7C]" />
            ...
            <div className="mt-4 space-y-3.5 text-xs">
              <div>
                ...
                <div className="mt-1.5 flex items-center gap-1.5 rounded-lg border border-slate-200 bg-[#F8FAFC] p-2 font-mono text-[11px] text-[#174A7C]">

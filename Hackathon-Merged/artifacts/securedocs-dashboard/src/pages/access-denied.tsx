    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#E2E8F0] pb-3">
        <div className="flex items-center gap-2 font-mono text-[11px] font-semibold text-[#64748B]">
          <Link href="/dashboard" className="transition-colors hover:text-[#174A7C]">
            SECUREDOCS
          </Link>
          <span>/</span>
          <Link href="/documents" className="transition-colors hover:text-[#174A7C]">
            DOCUMENT REPOSITORY
          </Link>
          <span>/</span>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div className="space-y-6 lg:col-span-8">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[#E2E8F0] bg-[#FFFFFF] p-8 shadow-sm sm:p-10">
            ...
            <div className="absolute top-0 inset-x-0 h-1.5 bg-gradient-to-r from-[#DC2626] via-[#B77900] to-[#DC2626]" />
            ...
            <div className="mt-8 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-5 sm:p-6">
              <div className="mb-4 flex items-center justify-between border-b border-[#E2E8F0] pb-3">
                <div className="flex items-center gap-2">
                  <FileKey size={18} className="text-[#174A7C]" />
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-lg border border-[#E2E8F0] bg-[#FFFFFF] p-3.5 shadow-2xs">
                  ...
                  <div className="mt-1.5 flex items-center gap-2">
                    <span className="inline-flex items-center gap-1.5 rounded-md border border-amber-300 bg-amber-50 px-2.5 py-1 text-xs font-bold text-[#B77900]">
                      <span className="size-2 rounded-full bg-[#B77900]" />
                      Restricted
                    </span>
                ...
                <div className="rounded-lg border border-red-200 bg-red-50/40 p-3.5 shadow-2xs sm:col-span-2">
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        <UserCheck size={16} className="text-[#2563A8]" />
                        <span className="font-mono text-sm font-bold text-[#174A7C]">
                          Level 2 Clearance
                        </span>
                        <span className="rounded bg-blue-100 px-1.5 py-0.5 text-[10px] font-bold uppercase text-[#174A7C]">
                          Operational
                        </span>
                      </div>
                    </div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                ...
                className="order-1 sm:order-none inline-flex items-center justify-center gap-2 rounded-xl bg-[#174A7C] px-6 py-3 text-sm font-bold text-white shadow-md transition-all hover:bg-[#123A61] hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#174A7C]/40 active:scale-[0.98]"
              >
              ...
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-xl border border-[#E2E8F0] bg-[#FFFFFF] px-4 py-2.5 text-xs font-bold text-[#111827] shadow-2xs transition-all hover:border-[#174A7C] hover:bg-blue-50/50 hover:text-[#174A7C] active:scale-[0.98]"
                >
                  <Send size={14} className="text-[#174A7C]" />
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-xl border border-[#E2E8F0] bg-[#FFFFFF] px-4 py-2.5 text-xs font-bold text-[#111827] shadow-2xs transition-all hover:border-[#174A7C] hover:bg-blue-50/50 hover:text-[#174A7C] active:scale-[0.98]"
                >
                  <Phone size={14} className="text-[#174A7C]" />
          ...
          <div className="rounded-2xl border border-amber-200/80 bg-gradient-to-r from-amber-50/60 to-orange-50/40 p-6 shadow-2xs">
            <div className="flex items-start gap-4">
              <div className="grid size-10 shrink-0 place-items-center rounded-xl bg-amber-100 text-[#B77900]">
                <ShieldAlert size={22} />
              </div>
        ...
        <div className="space-y-6 lg:col-span-4">
          ...
          <div className="rounded-2xl border border-[#E2E8F0] bg-[#FFFFFF] p-6 shadow-sm">
            <div className="flex items-center justify-between border-b border-[#E2E8F0] pb-3.5">
              <div className="flex items-center gap-2">
                <Fingerprint size={18} className="text-[#174A7C]" />
            ...
            <div className="mt-5 rounded-xl border border-[#E2E8F0] bg-[#0B1220] p-4 text-white">
              <div className="flex items-center justify-between text-[11px] font-semibold text-[#2563A8]">
          ...
          <div className="rounded-2xl border border-[#E2E8F0] bg-[#FFFFFF] p-6 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E2E8F0] pb-3.5">
              <HelpCircle size={18} className="text-[#174A7C]" />
              <h3 className="text-sm font-bold uppercase tracking-wider text-[#111827]">
                Help & Assistance
              </h3>
            </div>
            ...
            <div className="mt-5 space-y-2.5">
              <button
                type="button"
                onClick={() => setRequestModalOpen(true)}
                className="flex w-full items-center justify-between rounded-xl border border-[#E2E8F0] p-3 text-left transition-colors hover:border-[#174A7C] hover:bg-blue-50/50 group"
              >
                <div className="flex items-center gap-2.5">
                  <Send size={15} className="text-[#174A7C]" />
                  <div>
                    <div className="text-xs font-bold text-[#111827] group-hover:text-[#174A7C]">
              ...
              >
                <div className="flex items-center gap-2.5">
                  <Building2 size={15} className="text-[#174A7C]" />
                  <div>
                    <div className="text-xs font-bold text-[#111827] group-hover:text-[#174A7C]">
      ...
      <Dialog open={requestModalOpen} onOpenChange={setRequestModalOpen}>
        <DialogContent className="sm:max-w-md bg-white">
          <DialogHeader>
            <div className="flex items-center gap-2 text-[#174A7C]">
              <Send size={20} />
            ...
            <form onSubmit={handleRequestSubmit} className="space-y-4 py-2">
              <div>
                ...
                <textarea
                  ...
                  className="mt-1.5 w-full rounded-lg border border-[#E2E8F0] p-2.5 text-xs text-[#111827] outline-none focus:border-[#174A7C] focus:ring-1 focus:ring-[#174A7C]"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="mt-1.5 w-full rounded-lg border border-[#E2E8F0] p-2 text-xs text-[#111827] outline-none focus:border-[#174A7C]"
                  >
              ...
              <DialogFooter className="gap-2 sm:gap-0">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg bg-[#174A7C] px-5 py-2 text-xs font-bold text-white hover:bg-[#123A61]"
                >
        ...
        <DialogContent className="sm:max-w-md bg-white">
          ...
          <div className="space-y-3 py-2">
            <div className="rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-3.5">
              ...
              <div className="mt-3 flex items-center justify-between border-t border-[#E2E8F0] pt-2 text-xs">
                ...
                <button
                  ...
                  className="flex items-center gap-1 font-bold text-[#174A7C] hover:underline"
                >
                  <Copy size={12} />
                  <span>Copy</span>
                </button>
            ...
            <div className="rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-3.5">
              <div className="flex items-start justify-between">
                ...
                <span className="rounded bg-blue-100 px-2 py-0.5 text-[10px] font-bold text-[#174A7C]">
                  CLEARANCE L5
                </span>
              </div>
              <div className="mt-3 flex items-center justify-between border-t border-[#E2E8F0] pt-2 text-xs">
            ...
            <div className="rounded-xl border border-amber-200 bg-amber-50/70 p-3 text-[11px] text-amber-900">
              ...
              <div className="mt-1 flex items-center justify-between font-mono font-bold">
                ...
                <button
                  ...
                  className="text-[#174A7C] hover:underline"
                >
                  Copy
                </button>
              </div>
          ...
          <DialogFooter>
            <button
              ...
              className="w-full rounded-lg bg-[#174A7C] px-4 py-2 text-xs font-bold text-white hover:bg-[#123A61]"
            >
              Close
            </button>
          </DialogFooter>
        ...
        <DialogContent className="sm:max-w-lg bg-white">
            ...
            <div className="rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-base font-black text-[#174A7C]">Level 2 Clearance (Operational)</div>
                </div>
          ...
          <DialogFooter>
            <button
              ...
              className="rounded-lg bg-[#174A7C] px-4 py-2 text-xs font-bold text-white hover:bg-[#123A61]"
            >

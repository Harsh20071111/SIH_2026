...
export const SecureSidebar = ({ collapsed, onToggle }) => {
  const nav = [{ icon: FolderOpen, label: 'Dashboard', section: 'Main' }, { icon: FolderOpen, label: 'Cases', section: 'Main' }, { icon: FolderOpen, label: 'Documents', section: 'Main' }, { icon: FileText, label: 'All Documents', section: 'Documents', active: true, nested: true }, { icon: Upload, label: 'Upload Document', section: 'Documents', nested: true }, { icon: FileCheck2, label: 'Review Queue', section: 'Documents', nested: true }, { icon: ShieldCheck, label: 'Risk Center', section: 'Security' }, { icon: Fingerprint, label: 'Integrity Check', section: 'Security' }, { icon: History, label: 'Audit Logs', section: 'Security' }, { icon: FileArchive, label: 'Reports', section: 'Other' }, { icon: UserRound, label: 'Users', section: 'Other' }, { icon: Zap, label: 'Settings', section: 'Other' }];
